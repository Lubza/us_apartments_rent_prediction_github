...
st.markdown(
    ...
    **3. Model Development**  
    Random Forest, XGBoost, LASSO and Ridge regression models.

    **4. Model Evaluation**  
    Cross-validation and R² comparison on the held-out test set.

    **5. Hyperparameter Optimization**  
    RandomizedSearchCV with joint preprocessing and model tuning.
